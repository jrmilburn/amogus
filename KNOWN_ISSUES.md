...
- **Mobile UX follow-up:** new DOM interaction tests pass, but they do not render CSS or emulate native zoom. Check Safari/Android repeated taps, pinch, input-focus zoom, scrolling and simultaneous joystick/action touches; review short-landscape feedback, task/map disclosures and ten-player Chat/Vote panes on physical phones.
